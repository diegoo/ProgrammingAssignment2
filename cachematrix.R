...
## sort of 'object' containing a matrix & functions to access its
## inverse matrix
...
## return a matrix that is the inverse of 'x' & cache result if
## necessary
cacheSolve <- function(x, ...) {
    ...
    ## if already calculated, return cached result; else, calculate
    ## inverse & return it
